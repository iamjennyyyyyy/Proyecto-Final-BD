-- ============================================================
-- TRIGGERS CORREGIDOS — SPA Belleza y Relajación
-- ============================================================

-- ============================================================
-- 1. ACTUALIZAR PERSONAL FIJO EN ÁREAS
-- Dispara en INSERT/UPDATE/DELETE ON empleadosporarea
-- ============================================================
...
-- ============================================================
-- 2. ACTUALIZAR CANTIDAD DE MATERIALES AL USARLOS
-- Dispara en INSERT ON materialesporcita (AFTER)
-- ============================================================
...
-- ============================================================
-- 3. VERIFICAR STOCK SUFICIENTE ANTES DE USAR
-- Dispara en INSERT ON materialesporcita (BEFORE)
-- ============================================================
...
-- ============================================================
-- 4. VERIFICAR ESTADO DE CITA ANTES DE REGISTRAR MATERIALES
-- Dispara en INSERT ON materialesporcita (BEFORE)
-- Solo se pueden registrar materiales si la cita está "realizada"
-- ============================================================
...
-- ============================================================
-- 5. VALIDAR NOMBRE COMPLETO (EMPLEADOS)
-- Dispara en INSERT/UPDATE ON empleados
-- ============================================================
...
-- ============================================================
-- 6. VALIDAR NOMBRE COMPLETO (CLIENTES)
-- Dispara en INSERT/UPDATE ON clientes
-- ============================================================
...
-- ============================================================
-- 8. VALIDAR CI (CLIENTES) — misma lógica que DNI pero columna "ci"
-- Dispara en INSERT/UPDATE ON clientes
-- ============================================================

create or replace function validar_ci_cliente()
language plpgsql
returns trigger as $$
declare
  anho_real       int;
...
-- ============================================================
-- 9. VERIFICAR DISPONIBILIDAD DEL EMPLEADO (sin overlap)
-- Dispara en INSERT/UPDATE ON citas
-- ============================================================
...
-- ============================================================
-- 10. VERIFICAR PRECIO DE CITA SEGÚN REGLA DE NEGOCIO
-- Dispara en INSERT/UPDATE ON citas
-- ============================================================
...
-- ============================================================
-- 11. REGISTRAR PRECIO DE CITA AUTOMÁTICAMENTE
-- Dispara en INSERT/UPDATE ON citas (BEFORE, corre antes que trg_verificar_precio_cita)
-- Si es cita individual → precio = precio del tratamiento
-- Si es cita de paquete → precio = 0
-- ============================================================
...
-- ============================================================
-- 12. VERIFICAR QUE LA CITA NO SEA EN FECHA/HORA PASADA
-- Dispara en INSERT/UPDATE ON citas
-- ============================================================
...
-- ============================================================
-- 13. REGISTRAR PRECIO DE PAQUETE VENDIDO AUTOMÁTICAMENTE
-- Dispara en INSERT/UPDATE ON paquetevendido
-- ============================================================
...
-- ============================================================
-- 14. VERIFICAR FECHAS DEL PAQUETE VENDIDO
-- Dispara en INSERT/UPDATE ON paquetevendido
-- ============================================================
